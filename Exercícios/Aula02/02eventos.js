...
//     addEvent(eventos) {
//         eventos.preco += this.basePrice;
//         this.eventos.push(eventos); 
//     }

//     addUser(user){
//         let find = false;
//         this.eventos.forEach((element,index) => {  
                        
//             if(user.evento === index){
...
//             return this.users
//         }
//         return {erro: 'evento não encontrado', code: 404};      
//     }
// } 

// let tickManager = new TickManager();
// console.log('evento: ', tickManager.getEvents());

// let eventos = {name:"carlos", lugar:"SP", preco:4, capacidade:50, data: new Date()};

// tickManager.addEvent(eventos);

// console.log('eventos: ',tickManager.getEvents());

// let users = {evento:0, user:2};

// res = tickManager.addUser(users);

// if(res?.code === 404){
//     console.log(res.erro);
// }

// console.log('participante', tickManager.participants);
